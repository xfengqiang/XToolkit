...
{
    switch (type) {
        case ELaunchAnimationTypeCurl:
            return [YISplashScreenAnimation pageCurlAnimation];
        case ELaunchAnimationTypeMoveFromTop:
            return [YISplashScreenAnimation moveFromTopAnimation];
        default:
            break;
    }
    return nil;
